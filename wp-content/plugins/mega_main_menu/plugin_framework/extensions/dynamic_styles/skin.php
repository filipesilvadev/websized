...
#mega_main_menu' . $location_class . ' > .menu_holder
{
	' . mmpm_css_bg_image( $mmpm_theme_options[ $location_name . '_menu_bg_image' ] ) . '	
}
...
#mega_main_menu' . $location_class . ' > .menu_holder > .menu_inner > ul > li .mega_dropdown *
{
	color: ' . $mmpm_theme_options[ $location_name . '_menu_dropdown_plain_text_color'] . ';
}
...
#mega_main_menu' . $location_class . '.direction-horizontal > .menu_holder > .menu_inner > ul > li.nav_woo_cart > .item_link,
