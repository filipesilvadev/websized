<div class="article-masonry-meta-wrapper">
	...
	<div class="author-meta"><strong><?php _e("Author :", 'jeg_textdomain'); ?></strong> <a href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>"><?php echo get_the_author(); ?></a> </div>
	
	<div class="comment-meta">
		<strong><?php _e("Comment Number :", 'jeg_textdomain'); ?> </strong>
