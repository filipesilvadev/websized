...
<div class="toplink">
    <ul>
        <?php if(!is_user_logged_in()) { ?>
            <li class="toplogin">
                <a href="<?php echo get_page_link ( woocommerce_get_page_id( 'myaccount' ) ); ?>">Login or Register</a>
            </li>
        <?php } else { ?>
            <li class="topaccount">
                <a href="#">
                    ...
                    ?>
                    <span><?php _e('My Account', 'jeg_textdomain'); ?></span>
                </a>
                <div class="accountdrop ">
                    <ul id="right-account-menu">
