...
<div class="landingpagewrapper">
	...
	<?php
		 ...
		 * build heading page
		 **/
		$headingtype = vp_metabox('jkreativ_portfolio_landing.heading_type');
		switch ($headingtype) {
			case 'slider':
			...
			case 'parallaxheading':
				...
				$uselight        = ( vp_metabox('jkreativ_portfolio_landing.heading_normal.0.light_heading') == 1 ) ? 'light' : '';
				$coverbg         = ( vp_metabox('jkreativ_portfolio_landing.heading_normal.0.cover_parallax_background') == '1' ) ? 'cover' : 'auto' ;
				$backgroundimage = jeg_get_image_attachment ( vp_metabox('jkreativ_portfolio_landing.heading_normal.0.heading_background') );
				$overlaybgimage  = "<div class='parallaxoverlay' style='background-color: " . vp_metabox('jkreativ_portfolio_landing.heading_normal.0.overlay_color') . ";'></div>";
				?>
					...
					<section class="nomargin nopadding headingparallax <?php echo $uselight ?>">
						...
						<div class="sectioncontainer sectionheading parallaxtext">
							<div class="span6">
								<h2><?php echo vp_metabox('jkreativ_portfolio_landing.heading_normal.0.first_text_heading'); ?></h2>
								<span><?php echo vp_metabox('jkreativ_portfolio_landing.heading_normal.0.second_text_heading'); ?></span>
							</div>
						</div>
					</section>
				...
				break;
			case 'shortcode':
				echo  "<section class='nomargin nopadding'>" . apply_filters('the_content', vp_metabox('jkreativ_portfolio_landing.heading_shortcode')) . "</section>";
				break;
			case 'noheading':
			default:
				break;
...
<?php
    if(vp_option('joption.enable_section_builder') && vp_metabox('jkreativ_portfolio_landing.enable_landingnav', '1') === '1') :
?>
<div class="landing-navigator <?php echo vp_metabox('jkreativ_portfolio_landing.landingnav_type', 'default') ?>">
    <ul>
        <?php
        ...
        ?>
        <li for="<?php echo jeg_to_slug($section['section_id']) ?>" data-title="<?php echo $section['section_name'] ?>">
